...
**[NWFP_API_demo_enviroental data](https://github.com/North-Wyke-Farm-Platform/NWFP-API-Demo/blob/main/NWFP_API_demo_environment_data.ipynb)** demonstrates using fetchRothcdata api. The example retreives environemtal data over a certian period od time for a cathment
